...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WorldGoldCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node453453.net","213.252.244.218"},
    {"node823749.net","213.252.247.86"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WorldGoldCoin is probably already running."), addrBind.ToString().c_str());
        else
