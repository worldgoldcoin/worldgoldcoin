...
// Copyright (c) 2011-2012 WorldGoldCoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("WorldGoldCoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #WorldGoldCoinTEST0\r");
            Send(hSocket, "WHO #WorldGoldCoinTEST0\r");
        } else {
            // randomly join #WorldGoldCoin00-#WorldGoldCoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #WorldGoldCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #WorldGoldCoin%02d\r", channel_number).c_str());
        }
